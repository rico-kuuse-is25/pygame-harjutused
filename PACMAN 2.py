...
# LINK: https://github.com/DevinLeamy/Pacman/tree/master
# TESTIMINE: kõik toimis
# MEELDIB: Kasutajaliides on detailne ja näeb välja sarnane päris Pac-Manile, heli, Pac-Mani ja kummituste käitumine on detailselt läbi mõeldud
# EI MEELDI: Palju korduvat koodi, eriti piltide laadimisel
