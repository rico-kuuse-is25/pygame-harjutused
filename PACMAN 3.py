...
# LINK: https://github.com/mattharootunian/pacman/tree/main
# TESTIMINE: kõik toimis
# MEELDIB: Graafika ja animatsioonid on normaalsed, Punktisüsteem ja erinevad kummitused
# EI MEELDI: Kood on väga pikk ja kohati raskesti loetav
        ...
        for j in range(len(level[i])):
            ...
            if level[i][j] == 3:
                pygame.draw.line(screen, color, (j * num2 + (0.5 * num2), i * num1),
                                 (j * num2 + (0.5 * num2), i * num1 + num1), WIDTH // 300)
            if level[i][j] == 4:
                pygame.draw.line(screen, color, (j * num2, i * num1 + (0.5 * num1)),
                                 (j * num2 + num2, i * num1 + (0.5 * num1)), WIDTH // 300)
            if level[i][j] == 5:
