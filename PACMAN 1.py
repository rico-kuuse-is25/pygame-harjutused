...
# LINK: https://github.com/janjilecek/pacman_python_pygame/tree/main
# TESTIMINE: pidin laadima numpy ja tcod aga kõik toimis
# MEELDIB: Pac-Mani ja kummituste liikumine on selgelt tehtud, Mängu loogika on hästi eraldatud joonistamisest ja liikumisest
# EI MEELDI: Kui mõni pildifail puudub, võib programm kohe vea anda, Pildid skaleeritakse iga kaadri ajal uuesti
